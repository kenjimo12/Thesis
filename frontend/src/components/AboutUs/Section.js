        ...
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10 pt-16 sm:pt-20 pb-16 sm:pb-20">
          ...
          >
            ...
            <p className="mt-6 text-[15px] sm:text-[18px] lg:text-[20px] text-black/70 leading-relaxed max-w-[78ch]">
              We are a team of student developers committed to creating CheckIn, a
              student-centered web-based platform designed to promote mental wellness
              and responsible help-seeking. Guided by research, technology, and
              empathy, our goal is to provide students with a safe, confidential, and
              accessible space to reflect on their emotional well-being through
              evidence-based tools such as the PHQ-9. Through CheckIn, we aim to
              support early awareness, reduce stigma, and foster a more supportive
              academic environment where students feel empowered to care for their
              mental health.
            </p>
